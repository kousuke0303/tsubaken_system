class ConstructionReport < ApplicationRecord
  ...
  scope :uncheck_reports_for_vendor, ->{ where.not(sm_check: true) }
  ...
  ######## CALLBACK #############################
    ...
    def create_notifications
      if self.report != "not_set" || self.reason != "no_select"
        ...
        vendor_manager_code_id = construction_schedule.vendor.vendor_manager.member_code.id
        recievers_ids = matter.member_ids_in_charge.push(vendor_manager_code_id)
