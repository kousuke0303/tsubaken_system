class DefaultTaskRequest < ApplicationRecord
  ...
  scope :are_default_task_request, -> { where(default_task_request_1: "足場架設依頼", default_task_request_2: "発注依頼").group(:default_task_request_1, :default_task_request_2) }
