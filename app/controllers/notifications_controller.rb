  ...
  def schedule_index
    ...
    if params[:category] == "schedule" 
      if params[:action_type] == "create"
        ...
        @creation_schedules = Schedule.joins(:notification).where(notifications: {id: notification_ids})
        ...
        @updation_schedules = Schedule.joins(:notification).where(notifications: {id: notification_ids})
                                                  .order(:scheduled_date, :scheduled_start_time)
